...
def pipeline_enh2disease_rag_qasar():
    qa_plugin = QualityQASAR(api_key=QASAR_API_KEY)
    qa_config = QASARConfig(
        persistent=False,
        ontology_name="DiseaseEnhancer enh2disease Ontology - RAG + QASAR"
    )
    ...
    with open("enh2disease_rag_qasar.puml", "w", encoding="utf-8") as file:
    ...
    with open("enh2disease_rag_qasar_mappings.json", "w", encoding="utf-8") as file:
    ...
    with open("enh2disease_rag_qasar.ttl", "w", encoding="utf-8") as file:
    ...
    with open("enh2disease_rag_qasar_report.json", "w", encoding="utf-8") as file:
...
if __name__ == "__main__":
    pipeline_enh2disease_rag_qasar()
